...
export default function Header() {
  return (
    <div className="flex w-[80%] mx-auto my-5">
      <div className="relative bg-black text-white h-[20rem] w-8/12 py-11 px-9 overflow-hidden">
      ...
      <div className="bg-white text-[#0273ba] w-4/12 text-center  border-[#0273ba] border-2 ml-3 relative h-[20rem]">
        ...
        <div className="bg-[#0273ba] h-[7.2rem] leading-none">
          <div className="">
