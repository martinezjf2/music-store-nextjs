...
export default function Header() {
  return (
    <div className="flex w-[80%] mx-auto my-4">
      <div className="bg-black text-white h-[18rem] w-8/12 py-11 px-9 relative container">
      ...
      <div className="bg-white text-[#0273ba] w-4/12 text-center  border-[#0273ba] border-2 ml-3 relative h-[18rem]">
        ...
        <div className="bg-[#0273ba] h-[5.2rem] leading-none">
          <div className="">
            <button className="mt-4 bg-white py-2 px-8 text-[13px] rounded font-semibold">
              Shop Now
            </button>
          </div>
        </div>
