    ...
    <div className="text-center py-2 relative">
      ...
      <div className="flex md:w-[80%] m-auto pt-10">
        ...
        <div className="flex justify-center items-center  w-full">
          <div className="border rounded pt-5 px-2 pb-1 border-gray-200 mx-1 cursor-pointer hover:border-blue-700 hover:shadow-lg hover:scale-105 hover:duration-200">
